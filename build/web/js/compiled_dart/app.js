...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: [function() {
      S._loadJSON();
      S._startTextFieldPlaceholderTimer();
      var t1 = J.get$onInput$x($.$get$searchBarElement());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(S.app___updateSearchResults$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$0", "app__main$closure", 0, 0, 2],
    _updateSearchResults: [function(e) {
      $.timeoutCounter = $.timeoutCounter + 1;
      P.Timer_Timer(P.Duration$(0, 0, 0, 250, 0, 0), new S._updateSearchResults_closure());
    }, "call$1", "app___updateSearchResults$closure", 2, 0, 21],
    _clearResults: function() {
      var t1, t2;
      for (; t1 = $.$get$resultsListElement(), t1.firstChild != null;) {
        t1 = t1.firstChild;
        t2 = t1.parentNode;
        if (t2 != null)
          t2.removeChild(t1);
    ...
    _loadJSON: function() {
      W.HttpRequest_getString("snippets.json", null, null).then$1(new S._loadJSON_closure());
    },
    _startTextFieldPlaceholderTimer: function() {
      P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 1500, 0, 0), new S._startTextFieldPlaceholderTimer_closure());
    },
    _updateSearchResults_closure: {
      "^": "Closure:0;",
      call$0: function() {
        var t1, val, newIndexList, i;
        t1 = $.timeoutCounter - 1;
        $.timeoutCounter = t1;
        if (t1 < 0) {
          $.timeoutCounter = 0;
        ...
        if (t1 > 0)
          return;
        val = $.$get$searchBarElement().textContent;
        if (val === "") {
          $.currentIndexList = [];
          S._clearResults();
          t1 = $.$get$noItemsElement().style;
          t1.display = "none";
          return;
        }
        newIndexList = [];
        for (i = 0; C.JSInt_methods.$lt(i, C.JSNull_methods.get$length($.shortSnippets)); ++i)
          if (C.JSNull_methods.$index($.shortSnippets, i).contains$1(0, new H.JSSyntaxRegExp(val, H.JSSyntaxRegExp_makeNative(val, false, false, false), null, null)))
            newIndexList.push(i);
        if (!S._compare($.$get$currentIndexList(), newIndexList)) {
          $.currentIndexList = H.setRuntimeTypeInfo(newIndexList.slice(), [H.getTypeArgumentByIndex(newIndexList, 0)]);
          S._clearResults();
          ...
          t1 = $.$get$noItemsElement().style;
          t1.display = "none";
          C.JSArray_methods.forEach$1(newIndexList, new S._updateSearchResults__closure());
        }
      }
    },
    _updateSearchResults__closure: {
      "^": "Closure:9;",
      call$1: function(i) {
        var data, resultToAdd;
        data = J.$index$asx(J.$index$asx($.fullSnippets, 1), i);
        resultToAdd = C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add("<div id=\"result-index-", i) + "\" class=\"result-item panel\" style=\"position: relative\"><img src=\"", data.get$imageUrl()) + "\" alt=\"", data.get$imageAlt()) + "\" style=\"height: 80px; width: 80px; margin-right: 20px; float: left\"><div class=\"snippet-details\" style=\"margin-right: 40px\"><a href=\"", data.get$linkToFull()) + "\" target=\"_blank\"><h3>", data.get$title(data)) + "</h3></a><p>", data.get$categories()) + "</p></div><div class=\"snippet-buttons\" style=\"width: 30px; height: 80px; position: absolute; top: 0; right: 0\"><a><img src=\"img/fav-button.png\" alt=\"favorite button\" class=\"favorite-button ", data.get$favorite()) + "\" style=\"height: 20px; margin: 10px 0\"></a><a><img src=\"img/clipboard.png\" alt=\"clipboard\" class=\"copy-button ", data.get$copyable()) + "\" style=\"height: 20px; margin: 10px 0\"></a></div></div>";
        J.insertAdjacentHtml$4$treeSanitizer$validator$x($.$get$resultsListElement(), "beforeend", resultToAdd, null, null);
      }
    },
    _loadJSON_closure: {
      "^": "Closure:4;",
      call$1: function(responseText) {
        $.fullSnippets = C.JsonCodec_null_null.decode$1(responseText);
        P.print(responseText);
        P.print($.fullSnippets);
      }
    },
    _startTextFieldPlaceholderTimer_closure: {
      "^": "Closure:10;",
      call$1: function(t) {
        var t1, t2, t3;
        t1 = $.tfpi;
        ...
        t3 = $.$get$searchBarElement();
        if (t1 >= 5)
          return H.ioore(t2, t1);
        t3.setAttribute("placeholder", t2[t1]);
      }
    }
    ...
    Maps_mapToString_closure: {
      "^": "Closure:17;_collection$_box_0,_captured_result_1",
      call$2: function(k, v) {
        var t1, t2;
    ...
    _ValidatingTreeSanitizer_sanitizeTree_walk: {
      "^": "Closure:20;_html$_captured_this_0",
...
;
  ...
  }, "currentIndexList", "$get$currentIndexList", "currentIndexList", function() {
    return [];
  }, "resultsListElement", "$get$resultsListElement", "resultsListElement", function() {
    return W.querySelector("#results-list");
  }, "noItemsElement", "$get$noItemsElement", "noItemsElement", function() {
    return W.querySelector("#no-items-in-list");
  }, "searchBarElement", "$get$searchBarElement", "searchBarElement", function() {
    return W.querySelector("#search-bar");
  }, "tfp", "$get$tfp", "tfp", function() {
    return ["Splay Trees", "Quick Sort", "Load JSON", "Sticky Footer", "Inspirational Quote"];
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, void: true}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, args: [P.String]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.Timer]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, void: true, args: [W.Event]}];
